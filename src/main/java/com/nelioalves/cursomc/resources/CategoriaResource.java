...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert( @Valid @RequestBody CategoriaDTO objDTO) {// RequestBody convert o Json em objetos java
		Categoria obj = service.fromDTO(objDTO);													// automaticamente
